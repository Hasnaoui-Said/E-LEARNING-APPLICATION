...
<body class="font-[Montserrat] bg-[#E5E5E5]">
    ...
    <main class="absolute p-2 my-5 lg:top[60px] xl:top-[62px] 2xl:top[82px] top-[60px] lg:left-[270px] xl:left-[300px] 2xl:left-[400px] left-0 lg:w-[calc(100%-270px)] xl:w-[calc(100%-300px)] 2xl:w-[calc(100%-400px)] w-[100%]">
        ...
        <div class=" openModeLAddStu flex overflow-y-auto overflow-x-hidden fixed right-0 left-0 top-4 z-50 justify-center items-center md:inset-0 h-modal sm:h-full">
            <div class="relative px-4 w-full max-w-md h-full md:h-auto">
                ...
                <div class="relative flex flex-col rounded-lg drop-shadow-2xl bg-gray-300">
                    ...
                    <div class="text-start block">
                        <form class=" px-6 pt-2 pb-8 mb-4 w-[100%]" action="AddStu.php" method="POST">
                            <div class=" add__users">
                                ...
                                <input name="tel" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="username" type="text" placeholder="Username">
                                </div>
                                <div class="mb-4">
                                <label class="block text-gray-700 text-sm font-bold mb-2" for="password">
                                    Enroll Number
                                </label>
                                <input  name="enroll" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="username" type="text" placeholder="Username">
                                </div>
                                <div class="mb-4">
                                <label class="block text-gray-700 text-sm font-bold mb-2" for="password">
                                    Date Of Admission
                                </label>
                                <input  name="date_admission" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="username" type="text" placeholder="Username">
                                </div>
                            </div>
                            <div class="upload__file hidden">
                                <div class="mb-4">
                                <label class="hidden text-gray-700 text-sm font-bold mb-2" for="password">
                                    Chose file
                                </label>
                                <input  name="file_upload" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" type="file" placeholder="">
                                </div>
                            </div>
                            <div class="flex items-center justify-end mt-6">
                                ...
                                <a  onclick="closeModeLAddStu()" class="text-black hover:text-white hover:bg-[#00C1FE] rounded-lg text-sm px-5 py-2 text-center mr-2">
                                    Close
                                </a>
                            </div>
                        </form>
                    </div>
                    <!-- <div class="text-start hidden upload__file">
                        <form class=" px-6 pt-2 pb-8 mb-4 w-[100%]" action="AddStu.php" method="POST">
