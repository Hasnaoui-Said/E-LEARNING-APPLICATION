...
<body class="font-[Montserrat] bg-[#E5E5E5]">
    ...
    <main class="absolute p-2 my-5 lg:top[60px] xl:top-[62px] 2xl:top[82px] top-[60px] lg:left-[270px] xl:left-[300px] 2xl:left-[400px] left-0 lg:w-[calc(100%-270px)] xl:w-[calc(100%-300px)] 2xl:w-[calc(100%-400px)] w-[100%]">
        ...
        <div class="px-3 flex sm:flex-row flex-col justify-between items-center">
            <h1 class="text-[22px] font-bold">Cours list</h1>
            <div class="flex justify-between items-center">
                ...
                <p class="ml-3 px-3 py-1 text-white cursor-pointer rounded-[4px] uppercase bg-[#00C1FE]" onclick="openModeLAddStu()">Add new cours</p>
            </div>
        </div>
        ...
        <table class='[border-spacing:0_10px] border-separate mx-auto max-w-4xl w-full whitespace-nowrap overflow-hidden'>
                <thead>
                    <tr class="text-[#000] text-[12px] capitalize text-left">
                        <th class="text-sm pr-6 pl-2 py-3">title</th>
                        <th class="text-sm pr-6 pl-2 py-3">description</th>
                        <th class="text-sm pr-6 pl-2 py-3">price</th>
                ...
                <tbody>
                    ...
                    <tr class="bg-white text-slate-800 text-[14px] capitalize">
                        <td class="text-sm pr-6 pl-2 py-3"><?php echo $cour['title']?></td>
                        <td class="text-sm pr-6 pl-2 py-3"><?php echo $cour['description']?></td>
                        <td class="text-sm pr-6 pl-2 py-3"><?php echo $cour['price']?></td>
                        <td class="pr-6 pl-2">
                            <div class="flex gap-5">
                            <a href="./updateCours.php?type=update&id=<?php echo $cour['id'];?>" class="py-1">
                            ...
                            <a href="./cours.php?type=delete&id=<?php echo $cour['id'];?>" class="py-1" onclick="open_confermation_delete_cours()">
        ...
        <!-- Modale  onclick="openModeLAddcours()" -->
            ...
            <div class="relative px-4 w-full max-w-md h-full md:h-auto">
                ...
                <div class="relative flex flex-col rounded-lg drop-shadow-2xl bg-gray-300">
                    ...
                    <div class="text-start block">
                        <form class=" px-6 pt-2 pb-8 mb-4 w-[100%]" action="./../data/coursTraitement.php?type=add" method="POST">
                            <div class=" add__users">
                                <div class="mb-4">
                                    <label class="block text-gray-700 text-sm font-bold mb-2" for="username">
                                        Title:
                                    </label>
                                    <input required type="text" placeholder="Title" name="title" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">
                                </div>
                                <div class="mb-4">
                                <label class="block text-gray-700 text-sm font-bold mb-2" for="password">
                                    Description:
                                </label>
                                <textarea name="description" class="form-control block w-full px-3 py-1.5text-base font-normal text-gray-700 bg-white bg-clip-padding
                                ...
                                <input type="number" placeholder="Price" name="price" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">
                                </div>
                            </div>
            ...
            <div class="relative px-4 w-full max-w-md h-full md:h-auto">
                ...
                <div class="relative bg-white rounded-lg shadow">
                    ...
                    <div class="flex justify-between items-center p-2 bg-[#FAFFC1]">
                        ...
                        <a href="./cours.php" onclick="open_confermation_delete_stu()" class="text-slate-900 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-md text-sm">
                            <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div class="p-6 pt-0 flex flex-col text-center">
                        ...
                        <form action="./../data/coursTraitement.php?type=delete&id=<?php echo $_GET['id'] ?? ""; ?>"  method="POST" class="flex justify-end">
                            <a href="./cours.php" onclick="open_confermation_delete_stu()" class="cursor-pointer text-gray-500 bg-white hover:bg-gray-100 focus:ring-4 focus:ring-gray-300 rounded-lg border border-gray-200 text-sm font-medium px-5 py-2.5 hover:text-gray-900 focus:z-10 mr-2">
                                No, cancel
                            </a>
